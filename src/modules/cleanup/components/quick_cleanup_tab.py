...
ADVANCED_CATEGORIES = [
    ...
    ("complus_cache",              "COM+ App Cache",          "#90caf9"),
    ("office_cache_extended",      "Office Ext. Cache",       "#ce93d8"),
    ("onedrive_cache",             "OneDrive Mask Cache",     "#ef9a9a"),
    ("onedrive_commercial_cache",  "OneDrive Biz Cache",      "#80deea"),
    ("onedrive_full_cache",        "OneDrive Full Cache",     "#fff59d"),
    ("claude_cli_cache",           "Claude CLI Cache",        "#a5d6a7"),
    ("npp_cache",                  "Notepad++ Cache",         "#ffcc80"),
    ("vscode_cached_data",         "VSCode Cached Data",      "#b0bec5"),
    ("vscode_settings_sync",       "VSCode Settings Sync",    "#fff176"),
    ("xbox_app_cache",             "Xbox App Cache",          "#80cbc4"),
    ("amd_radeon_cache",           "AMD Radeon Cache",        "#c5e1a5"),
    ("browser_caches",             "Browser Cache (bulk)",    "#80d8ff"),
    ("d3d_shader_cache",           "Direct3D Shader Cache",   "#f8bbd0"),
    ("diag_logs",                  "Diagnostic Logs",         "#d1c4e9"),
    ("directx_shader_cache",       "DirectX Shader Cache",    "#aed6f1"),
    ("dxgi_cache",                 "DXGI Cache",              "#f1948a"),
    ("event_logs",                 "Event Log Files",         "#85c1e9"),
    ("font_cache",                 "Font Cache Service",      "#82e0aa"),
    ("language_packs",             "Language Pack Cache",     "#bb8fce"),
    ("memory_dumps",               "Memory Dumps",            "#f8c471"),
    ("minidump",                   "Kernel Minidumps",        "#73c6b6"),
    ("package_cache",              "Installer Payload Cache", "#58d68d"),
    ("per_drive_recycle_bin",      "Recycle Bin (all drives)","#ecf0f1"),
    ("per_drive_temp",             "Temp (all drives)",       "#90caf9"),
    ("sfc_logs",                   "SFC/DISM Logs",           "#ce93d8"),
    ("sysprep_logs",               "Sysprep Logs",            "#ef9a9a"),
    ("thumbnail_cache_central",    "Explorer Thumbcache",     "#80deea"),
    ("update_cleanup",             "Windows Update Cleanup",  "#fff59d"),
    ("wer_reports",                "Error Reporting Archive", "#a5d6a7"),
    ("windows_backup_catalog",     "Windows Backup Catalog",  "#ffcc80"),
    ("windows_backup_logs",        "Server Backup Logs",      "#b0bec5"),
    ("windows_setup_diags",        "Setup Diag Logs",         "#fff176"),
